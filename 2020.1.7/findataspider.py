...
class Spider():
    ...
    def run(self):
        ...
        #2.发送请求
        # self.download_csv_multexector(stock)
        self.download_csv_multprosess(stock)
        #3.提取数据
        #4.保存
        pass
