...
def Run( stock):
    try:
        annual_report = szseAnnual(1, stock)
        stock_report = szseStock(1, stock)
        annual_report_ = sseAnnual(1, stock)
        stock_report_ = sseStock(1, stock)
    except:
        print(1, 'page error, retrying')
        try:
            annual_report = szseAnnual(1, stock)
        except:
            print(1, 'page error')
